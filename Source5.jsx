...
var downloadBasePath = BASE_FOLDER + "/Download";
var outputBasePath = BASE_FOLDER + "/Output";
var mockupBasePath = BASE_FOLDER + "/Mockup";
...
var mockupPaths = [
    mockupBasePath + "/011.psd",
    mockupBasePath + "/03_h.psd",
    mockupBasePath + "/051_w.psd",
    mockupBasePath + "/081_w.psd",
    mockupBasePath + "/05 (2).psd"
];

var newMockupPath = mockupBasePath + "/04 (2).psd";
...
function processRolledImage(baseName, patternPath, outputFolder) {
    ...
    try {
        ...
        // Scale the pasted layer by 200%
        soDoc.activeLayer.resize(200, 200, AnchorPosition.TOPLEFT);
        // Rotate the pasted layer 90 degrees clockwise
        ...
        // Resize the pasted layer to exactly 2864x2864 pixels
        ...
        var widthScale = (2864 / currentWidth) * 100;
        var heightScale = (2864 / currentHeight) * 100;
        soDoc.activeLayer.resize(widthScale, heightScale, AnchorPosition.TOPLEFT);
        errorLog += "Resized layer to 2864x2864 pixels\n";
        ...
        // Suppress notifications; log errors silently
